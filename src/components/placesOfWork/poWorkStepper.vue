<template>
  <v-card class="elevation-0">
    <h3 class="pa-4">Опыт работы</h3>

    <v-stepper color="grey darken-3" vertical non-linear v-model="selected">
          ...
          projects: [
            {
              ...
              description:
                "Разработка системы детектирования очагов возгорания",
              tags: ["Прикладное ПО", "C#", "Компьютерное зрение", "EmguCV"],
              image: "/images/seeWhite.png"
            }
          ],
          content: "Команда, созданная амбициозными студентами Камышинского технологического института."
        },
        {
          name: "У олегыча",
          description: "",
